...
Prefer a compatible Python runtime already available to Claude Code. If the `neo4j` package is absent, install it only into a temporary external directory rather than a repository or global Python environment.
