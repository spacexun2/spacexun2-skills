...
description: Preserve project continuity with evidence-backed handoffs or retrospectives. Use when the user asks to transfer work to another agent or future task, close a project stage, or extract proven lessons. Do not use for ordinary status, MyDay, casual recaps, or routine executor delivery reviews.
---
