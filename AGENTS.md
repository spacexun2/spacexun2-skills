...
- Prefer `apply_patch` for scoped manual edits. If scripting is necessary, use explicit UTF-8 and avoid embedding Chinese literals through an uncertain shell transport.
